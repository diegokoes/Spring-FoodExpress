...
VALUES ('admin', 'admin123', 'Admin Root', 'admin@foodexpress.com', 1),
...
VALUES ('Burger Planet', 'Calle Luna 45', '600111222'),
       ('Pasta Nova', 'Av. Italia 12', '600222333'),
       ('Sushi Go', 'Calle Japón 3', '600333444');


-- Platos (unos 15 para paginar)
INSERT INTO dishes (name, price, category, restaurant_id)
VALUES ('Cheeseburger', 8.50, 'Hamburguesas', 1),
...
-- Pedidos
INSERT INTO orders (order_date, status, user_id, restaurant_id)
VALUES ('2025-10-01 12:00:00', 'ENTREGADO', 2, 1),
